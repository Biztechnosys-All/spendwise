    ...
    public class CheckoutModel : PageModel
    {
        ...
        public IActionResult OnPostAddCheckOutDetails()
        {
            ...
            var order = new Orders
            {
                ...
                CompanyName = Request.Cookies["companyName"],
                CompanyId = companyId,
                NetAmount = Convert.ToDecimal(Request.Cookies["NetAmount"].Replace("£", "")),
                VatAmount = Convert.ToDecimal(Request.Cookies["VatAmount"].Replace("£", "")),
                TotalAmount = Convert.ToDecimal(Request.Cookies["TotalAmount"].Replace("£", "")),
                AmountDue = Convert.ToDecimal(Request.Cookies["TotalAmount"].Replace("£", "")),
